...
class StylistSerializer(serializers.ModelSerializer):
    ...
    salon_city = serializers.CharField(source='salon.city')
    salon_zipcode = serializers.CharField(source='salon.zip_code')
    salon_state = serializers.CharField(source='salon.state')
    ...
    class Meta:
        ...
        fields = [
            ...
            'salon_name', 'salon_address', 'salon_zipcode', 'salon_city', 'salon_state',
        ]
