...
class Stylist(models.Model):
    ...
    tax_rate = models.DecimalField(max_digits=5, decimal_places=4, default=DEFAULT_TAX_RATE)
    card_fee = models.DecimalField(max_digits=5, decimal_places=4, default=DEFAULT_CARD_FEE)
